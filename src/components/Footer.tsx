      ...
      <div style={{ padding: '64px 0 48px' }}>
        <div className="container-wp">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '40px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                <a href="#" aria-label="Facebook"
                  style={{ width: '34px', height: '34px', background: '#2D7A2F', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', textDecoration: 'none', fontSize: '0.75rem', fontWeight: 700 }}>
                  f
                </a>
                ...
                <a href="https://wa.me/593999999999" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
                  style={{ width: '34px', height: '34px', background: '#25D366', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', textDecoration: 'none', fontSize: '0.65rem', fontWeight: 700 }}>
                  WA
                </a>
              </div>
            </div>
            ...
            {/* Col 2 — Links */}
            <div>
              <h4 style={{ color: '#F7D91E', fontWeight: 700, fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: '20px', paddingBottom: '12px', borderBottom: '1px solid #2a2a2a' }}>
                Páginas
              </h4>
